<section id="about" class="bg-[#0D0D0D]" >
    <div class="container py-20">
        ...
        <h1 class="text-white mt-20 pb-4 border-b-[1px] border-orange font-bold" data-aos='fade-right' data-aos-once="true">Presenting Puperior Service Through Innovative Concepts That Dare <span class="text-orange">To Be Different</span></h1>
        <div class=" flex justify-between flex-col lg:flex-row py-5" data-aos='fade-up' data-aos-once="true">
            <div class="lg:w-1/2">
