<section id="about" class="bg-[#0D0D0D]" >
    <div class="container py-5 ">
        ...
        <h1 class="text-white mt-20 pb-4 border-b-[1px] border-[#626262] font-bold" data-aos='fade-right' data-aos-once="true">Presenting Puperior Service Through Innovative Concepts That Dare To Be Different</h1>
