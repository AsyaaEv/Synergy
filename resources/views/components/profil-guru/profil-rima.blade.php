            ...
            <div class="lg:w-[25%] md:w-[30%] ">
                <div class="flex bg-secD rounded-lg mb-3 p-3 shadow-md">
                    <div class="w-full flex justify-center flex-col items-center">
                        <img class="mb-4 pointer-events-none md:w-full md:h-[15rem] w-[50%] h-[10rem] rounded-lg object-cover" src="https://smkn1bangsri.sch.id/assets/images/rima.jpg" alt="">
                        <p class="mb-0 text-black font-bold text-center">Rima Ariona Nur Awalia, S.Pd</p>
                        <p class="mb-0 text-black font-medium text-center">Sekertaris Jurusan, Sie PKL</p>
                    </div>
                </div>
                ...
                <div class="justify-start text-start flex">
                    <div class="w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="mb-0">Bu rima adalah guru produktif PPLG yang mengajar Front-End. Bu rima tidak hanya mengajar mengenai front-end tapi juga mengajar database dan php, dengan harapan siswa tidak hanya paham mengenai tampilan tapi juga database.</p>
                        </div>
                    </div>
                </div>
                <div class="flex w-full flex-col lg:flex-row justify-between">
                    <div class="lg:w-[55%] w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-user-circle text-2xl absolute top-0 left-0"></i>Nama Panggilan : <span class="font-bold">Bu Rima</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-calendar text-2xl absolute top-0 left-0"></i>Tempat / Tanggal Lahir : <span class="font-bold">Banjarnegara, 27 September 1992</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-book-bookmark text-2xl absolute top-0 left-0"></i>Mapel : <span class="font-bold">Front-End</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-identification-badge text-2xl absolute top-0 left-0"></i>NIP : <span class="font-bold">199209272020122005</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-barcode text-2xl absolute top-0 left-0"></i>Kode Guru : <span class="font-bold">BS</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-envelope text-2xl absolute top-0 left-0"></i>Email : <span class="font-bold">rima.ariona47@gmail.com</span></p>
                        </div>
                    </div>
