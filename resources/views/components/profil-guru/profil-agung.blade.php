            ...
            <div class="lg:w-[25%] md:w-[30%] ">
                <div class="flex bg-secD rounded-lg mb-3 p-3 shadow-md">
                    <div class="w-full flex justify-center flex-col items-center">
                        <img class="mb-4 pointer-events-none md:w-full md:h-[15rem] w-[50%] h-[10rem] rounded-lg object-cover" src="https://smkn1bangsri.sch.id/assets/images/073843f08c589c1057689701850f971c.jpg" alt="">
                        <p class="mb-0 text-black font-bold text-center">Dwi Agung Suhartono,ST</p>
                        <p class="mb-0 text-black font-medium text-center">Sie Sarana Prasarana</p>
                    </div>
                </div>
                ...
                <div class="justify-start text-start flex">
                    <div class="w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="mb-0">Pak Agung adalah guru produktif PPLG yang mengejar UI/UX. Pak agung membekali anak didiknya dengan banyak skill dari pebuatan logo, design website, vector, dan masih banyak lagi.</p>
                        </div>
                    </div>
                </div>
                <div class="flex w-full flex-col lg:flex-row justify-between">
                    <div class="lg:w-[55%] w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-user-circle text-2xl absolute top-0 left-0"></i>Nama Panggilan : <span class="font-bold">Pak Agung</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-calendar text-2xl absolute top-0 left-0"></i>Tempat / Tanggal Lahir : <span class="font-bold">Jepara, 30 Maret 1981</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-book-bookmark text-2xl absolute top-0 left-0"></i>Mapel : <span class="font-bold">UI/UX</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-identification-badge text-2xl absolute top-0 left-0"></i>NIP : <span class="font-bold">198103302010011016</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-barcode text-2xl absolute top-0 left-0"></i>Kode Guru : <span class="font-bold">L</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-envelope text-2xl absolute top-0 left-0"></i>Email : <span class="font-bold">agungmikro2@gmail.com</span></p>
                        </div>
                    </div>
                    <div class="lg:w-[40%] w-full h-auto">
                        <div class="bg-secD h-auto rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-bold mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-student text-2xl absolute top-0 left-0"></i>S-1 Teknik Informatika Komputer</p>
