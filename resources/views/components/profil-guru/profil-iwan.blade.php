<section class="pb-5">
    <div class="lg:h-[50vh] h-[40vh]  bg-no-repeat bg-center bg-cover" style="background-image: url({{ "https://tailwindui.com/img/beams-basic.png"}});">
    </div>
            ...
            <div class="lg:w-[25%] md:w-[30%] ">
                <div class="flex bg-secD rounded-lg mb-3 p-3 shadow-md">
                    <div class="w-full flex justify-center flex-col items-center ">
                        <img class="mb-4 pointer-events-none md:w-full md:h-[15rem] w-[50%] h-[10rem] rounded-lg object-cover" src="https://smkn1bangsri.sch.id/assets/images/iwan.jpg" alt="">
                        <p class="mb-0 text-black font-bold text-center">Iwan Safrudin, S.Pd</p>
                        <p class="mb-0 text-black font-medium text-center">Bendahara</p>
                    </div>
                </div>
                <div class="bg-secD rounded-lg mb-4 shadow-md h-20 flex justify-center items-center">
                    <div class="flex gap-4">
                        <div class="text-6xl p-1.5 rounded-lg text-slate-50 ">
                            <a href="">
                                <svg class="shrink-0 w-[40px] h-[40px] relative overflow-visible" style="" width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="p-1.5 rounded-lg ">
                            <a href="">
                                <svg class="shrink-0 w-[40px] h-[40px] relative overflow-visible" style="" width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <svg class="w-[100%] overflow-visible" style="" width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="justify-start text-start flex">
                    <div class="w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="mb-0">Pak Azzam adalah guru produktif RPL yang mengajar pelajaran PKK (Produk Kreatif dan Kewirausahaan). Pak Azzam membekali murid didiknya dengan ilmu berwirausaha, yang dimana dengan adanya pembelajaran dari pak azzam diharapkan dapat mengurangi angka penganguran</p>
                        </div>
                    </div>
                </div>
                <div class="flex w-full flex-col lg:flex-row justify-between">
                    <div class="lg:w-[55%] w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-user-circle text-2xl absolute top-0 left-0"></i>Nama Panggilan : <span class="font-bold">Pak Iwan</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-calendar text-2xl absolute top-0 left-0"></i>Tempat / Tanggal Lahir : <span class="font-bold">Jepara, 16 Januari 1993</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-book-bookmark text-2xl absolute top-0 left-0"></i>Mapel : <span class="font-bold">Back-End</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-identification-badge text-2xl absolute top-0 left-0"></i>NIP : <span class="font-bold">199301162022211008</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-barcode text-2xl absolute top-0 left-0"></i>Kode Guru : <span class="font-bold">AW</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-envelope text-2xl absolute top-0 left-0"></i>Email : <span class="font-bold">iwan.smkn1bangsri.sch.id</span></p>
                        </div>
                    </div>
                    <div class="lg:w-[40%] w-full h-auto">
                        <div class="bg-secD h-auto rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-bold mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-student text-2xl absolute top-0 left-0"></i>S-1 Rekayasa Perangkat Lunak</p>
