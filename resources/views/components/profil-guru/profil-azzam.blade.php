                ...
                <div class="flex w-full flex-col lg:flex-row justify-between">
                    <div class="lg:w-[55%] w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-calendar text-2xl absolute top-0 left-0"></i>Tempat / Tanggal Lahir : <span class="font-bold">Kudus, 3 September 1993</span></p>
                            ...
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-identification-badge text-2xl absolute top-0 left-0"></i>NIP : <span class="font-bold">199309032020121009</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-barcode text-2xl absolute top-0 left-0"></i>Kode Guru : <span class="font-bold">BR</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-envelope text-2xl absolute top-0 left-0"></i>Email : <span class="font-bold">alhaqqonny.az@gmail.com</span></p>
                        </div>
                    </div>
                    <div class="lg:w-[40%] w-full h-auto">
                        <div class="bg-secD h-auto rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-bold mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-student text-2xl absolute top-0 left-0"></i>S-1 Pendidikan Teknik Infromatika dan Komputer</p>
