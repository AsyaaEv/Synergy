            ...
            <div class="lg:w-[25%] md:w-[30%] ">
                <div class="flex bg-secD rounded-lg mb-3 p-3 shadow-md">
                    <div class="w-full flex justify-center flex-col items-center">
                        <img class="mb-4 pointer-events-none md:w-full md:h-[15rem] w-[50%] h-[10rem] rounded-lg object-cover" src="https://smkn1bangsri.sch.id/assets/images/c17c695a74a031bd7078ac0863aa4ebf.jpg" alt="">
                        <p class="mb-0 text-black font-bold text-center">Eko Siswanto, S.Kom</p>
                        <p class="mb-0 text-black font-medium text-center">Sie PKL</p>
                    </div>
                </div>
                ...
                <div class="justify-start text-start flex">
                    <div class="w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="mb-0">Pak Eko adalah Guru produktif PPLG yang mengajarkan mengenai Hardware dan flow kerja. Tidak hanya mengajar tapi pak Eko adalah guru yang juga mengurus PKL siswa/siswi jurusan PPLG</p>
                        </div>
                    </div>
                </div>
                <div class="flex w-full flex-col lg:flex-row justify-between">
                    <div class="lg:w-[55%] w-full h-full">
                        <div class="bg-secD rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-user-circle text-2xl absolute top-0 left-0"></i>Nama Panggilan : <span class="font-bold">Pak Eko</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-calendar text-2xl absolute top-0 left-0"></i>Tempat / Tanggal Lahir : <span class="font-bold">Jepara, 21 Juli 1976</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-book-bookmark text-2xl absolute top-0 left-0"></i>Mapel : <span class="font-bold">BKK</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-identification-badge text-2xl absolute top-0 left-0"></i>NIP : <span class="font-bold">197607212010011010</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-barcode text-2xl absolute top-0 left-0"></i>Kode Guru : <span class="font-bold">AZ</span></p>
                            <p class="font-medium mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-envelope text-2xl absolute top-0 left-0"></i>Email : <span class="font-bold">ekosmanjapati@gmail.com</span></p>
                        </div>
                    </div>
                    <div class="lg:w-[40%] w-full h-auto">
                        <div class="bg-secD h-auto rounded-lg mb-4 p-3 shadow-md">
                            ...
                            <p class="font-bold mb-2.5 relative pl-[1.9rem]"><i class="ph-fill ph-student text-2xl absolute top-0 left-0"></i>S-1 Manajemen informatika dan komputer</p>
