<footer id="footer" class="bg-hitam">
    <div class="mx-auto w-full md:h-[20rem] h-auto md:relative max-w-screen-xl flex items-center justify-between p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between lg:justify-normal md:flex-col lg:flex-row md:container">
            <div class="md:flex md:justify-between lg:gap-10 lg:justify-normal md:mx-10 lg:mx-0">
                <div class="mb-6 md:mb-0 md:w-[14rem]">
                    <a href="#" class="flex items-center no-underline">
                        <img src="{{Storage::url('assets/pplg/img/pplg-logo.png')}}" class="lg:h-14 h-12 w-auto" alt="" />
                        <div class="flex-col ml-5 mt-3">
                            <span class="self-center text-2xl md:text-2xl font-bold text-orange decoration-hitam">PPLG</span>
                            <p class="text-white font-bold">SMK N 1 BANGSRI</p>
                        </div>
                    </a>
                    <div class="flex-col">
                        <p class="text-white text-sm">Synergy Crop is an established comany under the name</p>
            ...
            <div class="flex right-0 md:absolute bottom-0 gap-1 md:mr-10 lg:mr-5 mr-5">
                <i class="ph-thin ph-copyright md:text-lg text-sm text-white"></i>
                <p class="text-white md:mt-1 text-sm md:text-xs">All rights reserved <span class="text-white font-semibold">| PT
                        Synergy
                        Berkah
                        Mandiri</span></p>
            </div>
