<section id="programKerja" class="w-full h-auto bg-hitam">
    <div class="container py-5">
        ...
        <div class="w-auto h-auto mt-5">
            <h1 class=" font-bold text-lg lg:text-[1.5rem] text-center text-white">PROGRESS PROGAM KERJA</h1>
            <h1 class=" font-bold text-lg lg:text-[1.5rem] text-center text-white">PROGAM KEAHLIAN PENGEMBANGAN
                PERANGKAT LUNAK
                DAN
                GIM
            </h1>
        ...
        <div class="w-full md:hidden lg:hidden">
            <div id="accordion-flush" data-accordion="collapse"
                ...
                data-inactive-classes="text-hitam bg-gray-300 dark:text-gray-400 dark:shadow-sm" class="mt-5">
                <h2 id="accordion-flush-heading-1">
                    <button type="button"
                        class="flex items-center rounded-lg w-full justify-between py-2 font-medium rtl:text-right text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400 gap-3"
                        data-accordion-target="#accordion-flush-body-1" aria-expanded="true"
                        aria-controls="accordion-flush-body-1">
                        <span class="text-lg font-bold ml-[2rem] capitalize">Progam Kerja Tahunan</span>
                        <i class="ph-bold ph-arrow-circle-right mr-[3rem]"></i>
                    </button>
                </h2>
                <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                    <div
                        class="py-2 border-b bg-white rounded-lg mb-2 flex flex-wrap border-gray-200 dark:border-gray-700">
                ...
                <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                    <div
                        ...
                        <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                            <i class="ph-bold text-orange ph-info text-xl"></i>
                            <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">Koordinasi Jurusan
                                PPLG
                            </h1>
                        </div>
                        <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                ...
                <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                    <div class="py-2 border-b bg-white rounded-lg flex flex-wrap border-gray-200 dark:border-gray-700">
                        <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                            <i class="ph-bold text-orange ph-info text-xl"></i>
                            <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">
                                Penyusunan dan
        ...
        <!-- accordion -->
        <div class="w-full hidden md:block lg:block gap-6">
            <div id="accordion-flush" data-accordion="collapse"
                data-active-classes="bg-white dark:shadow-xl text-orange dark:text-white"
                data-inactive-classes="text-hitam bg-gray-300 dark:text-gray-400 dark:shadow-sm"
                class="mt-5 w-full justify-center flex h-auto lg:gap-[10rem] items-center">
                <div class="w-[40%] lg:w-[32%] flex-col h-auto">
                ...
                <div class="w-[50%] lg:w-[40%] flex-row h-[40svh] relative border-4 border-white">
                    <div id="accordion-flush-body-4" class="hidden w-full h-full"
                        aria-labelledby="accordion-flush-heading-4">
                        <div
                            class="py-2 border-b w-full h-full bg-white rounded-lg flex flex-wrap border-gray-200 dark:border-gray-700">
                            <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                                <i class="ph-bold text-orange ph-info text-xl"></i>
                                <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">
                                    UKK PPLG
                    ...
                    <div id="accordion-flush-body-5" class="hidden w-full h-full"
                        aria-labelledby="accordion-flush-heading-5">
                        <div
                            class="py-2 border-b h-full bg-white rounded-lg mb-2 flex flex-wrap border-gray-200 dark:border-gray-700">
                            <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                                <i class="ph-bold text-orange ph-info text-xl"></i>
                                <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">
                                    Sinkronisasi
                            ...
                            <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                                <i class="ph-bold text-orange ph-info text-xl"></i>
                                <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">Koordinasi
                                    Jurusan
                                    PPLG
                                </h1>
                            </div>
                    ...
                    <div id="accordion-flush-body-6" class="hidden w-full h-full"
                        aria-labelledby="accordion-flush-heading-6">
                        <div
                            class="py-2 border-b h-full w-full bg-white rounded-lg flex flex-wrap border-gray-200 dark:border-gray-700">
                            <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                                <i class="ph-bold text-orange ph-info text-xl"></i>
                                <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">
                                    Penyusunan dan
