<section id="programKerja" class="w-full h-auto bg-hitam">
    <div class="container py-5">
        ...
        <div class="w-auto h-auto mt-5">
            ...
            <h1 class=" font-bold text-[1rem] lg:text-[1.5rem] text-center text-white">PROGAM KEAHLIAN PENGEMBANGAN PERANGKAT LUNAK DAN
                GIM
            </h1>
        </div>
        <!-- accordion HP-->
        {{-- <div class="w-full flex  md:hidden lg:hidden justify-center items-center h-auto">
            <div id="accordion-flush" data-accordion="collapse"
                ...
                <div class="w-full h-auto justify-center items-center bg-white flex flex-col rounded-xl">
                    ...
                    <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                        <div
                            class=" border-b bg-white flex flex-wrap border-gray-200 dark:border-gray-700">
                    ...
                    <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                        <div
                            class=" border-b bg-white rounded-lg flex flex-wrap border-gray-200 dark:border-gray-700">
                            <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                                <i class="ph-bold text-orange ph-info text-xl"></i>
                                <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">
        ...
        <div id="accordion-flush" data-accordion="collapse"
            ...
            <div id="accordion-flush-body-4" class="w-[50%] hidden h-[28svh] md:flex" aria-labelledby="accordion-flush-heading-4" data-aos-once="true" data-aos='fade-left'>
                <div
            ...
            <div id="accordion-flush-body-5" class="w-[50%] h-[28svh] flex" aria-labelledby="accordion-flush-heading-5">
                <div
            ...
            <div id="accordion-flush-body-6" class="w-[50%] h-[28svh] flex" aria-labelledby="accordion-flush-heading-6">
                <div
            ...
            <div id="accordion-flush" data-accordion="collapse"
                ...
                <div class="w-full h-auto justify-center items-center bg-white flex flex-col rounded-xl">
                    ...
                    <div id="accordion-flush-body-4" class="hidden" aria-labelledby="accordion-flush-heading-4">
                        <div
                            class="py-2 border-b bg-white  mb-2 flex flex-wrap border-gray-200 dark:border-gray-700">
                            <div class="flex w-full lg:w-[30rem] mt-2 h-auto space-x-3 ml-[2rem]">
                                <i class="ph-bold text-orange ph-info text-xl"></i>
                                <h1 class="text-hitam ml-[5rem] font-semibold text-sm dark:text-gray-400">
                                    UKK PPLG
