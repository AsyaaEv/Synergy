<section class="w-full h-screen">
    ...
    <div class="container flex justify-between h-[80svh] border-b-2 border-solid pb-8 px-4">
        <div class="flex-col w-[35%] border-2 border-hitam">
            ...
            <div class="flex flex-col mr-5 mt-2">
                <p class="font-semibold text-hitam text-lg  text-start">Sosial Media :</p>
        ...
        <div class="bg-white w-[60%] h-auto mt-10 border-hitam border-2 shadow-2xl rounded-3xl">
            ...
            <div class="w-full flex justify-center flex-col items-center">
                ...
                <div class="w-[85%] border-2 border-hitam flex mt-10 h-auto mb-3">
                    <div class="flex-col w-full gap-3 relative">
                        <div class="w-full bg-blue-gray-100 h-28 rounded-[15px]"></div>
    ...
    <div class="container w-full h-screen mt-10 flex flex-col justify-center">
        <div class="w-[90%] h-[13svh] flex justify-center">
            <div class="block w-full max-w-screen-xl px-6 py-3 mx-auto text-white bg-white border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
                <div class="flex items-center justify-between text-blue-gray-900">
                    <a href="#" class="mr-4 block cursor-pointer py-1.5 font-sans text-base font-semibold leading-relaxed tracking-normal text-inherit antialiased">Material Tailwind</a>
        ...
        <div data-tab-content="" class="p-5">
            <div class="opacity-100" id="app" role="tabpanel">
