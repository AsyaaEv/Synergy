    ...
    <div class="container md:flex-row flex flex-col md:justify-between lg:h-[80svh] border-b-2 border-solid pb-8 px-4">
        <div class="flex-col md:w-[35%] w-full border-2 border-hitam">
            ...
            <div class="flex flex-col justify-center items-center">
                <h1 class="lg:text-2xl md:text-lg text-sm font-bold px-2 py-2 border-2 md:rounded-2xl rounded-lg border-hitam">Iwan Safrudin, S.Kom</h1>
                <h1 class="lg:text-2xl text-lg font-semibold text-center mt-2">Wali Kelas X PPLG 2</h1>
                <a href="/profil-iwan" class="text-decoration-none w-[7rem] bg-secD border-2 border-hitam py-3 px-6 mt-3 rounded-lg text-xl font-bold text-hitam hover:text-orange hover:border-orange transition-all">Profile</a>
            </div>
        </div>
