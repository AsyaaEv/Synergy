                        ...
                        <div class="swiper swiper-kelas lg:pt-[70px] mySwiper-kelas">
                            <div class="swiper-wrapper slide-kelas-wrap pb-20 ">
                                <div class="swiper-slide  slide-kelas">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(1).jpg') }}" />
                                </div>
                                <div class="swiper-slide  img-fluid mx-2 slide-kelas shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(4).jpg') }}" />
                                </div>
                                <div class="swiper-slide  img-fluid mx-2 slide-kelas shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(5).jpg') }}" />
                                </div>
                                <div class="swiper-slide  img-fluid mx-2 slide-kelas shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(7).jpg') }}" />
                                </div>
                            </div>
                    ...
                    <div class="block w-full items-center antialiased leading-relaxed h-auto">
                        <div class="swiper swiper-kelas lg:pt-[70px] mySwiper-kelas">
                            <div class="swiper-wrapper slide-kelas-wrap pb-20 ">
                                ...
                                <div class="swiper-slide  slide-kelas img-fluid mx-2 shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(8).jpg') }}" />
                                </div>
                            </div>
                            <div class="flex justify-center">
                                <div class="arrow-swiper-kelas">
                ...
                <div class="hidden opacity-0" id="settings" role="tabpanel">
                    <div class="block w-full items-center antialiased leading-relaxed h-auto">
                        <div class="swiper swiper-kelas lg:pt-[70px] mySwiper-kelas">
                            <div class="swiper-wrapper slide-kelas-wrap pb-20 ">
                                <div class="swiper-slide  img-fluid mx-2 slide-kelas shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(3).jpg') }}" />
                                </div>
                                <div class="swiper-slide  img-fluid mx-2 slide-kelas shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(2).jpg') }}" />
                                </div>
                                <div class="swiper-slide  img-fluid mx-2 slide-kelas shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplg1/pplg1(6).jpg') }}" />
                                </div>
                            </div>
                            <div class="flex justify-center">
                                <div class="arrow-swiper-kelas">
