    ...
    <div class="container md:flex-row flex flex-col md:justify-between lg:h-[80svh] border-b-2 border-solid pb-8 px-4">
        <div class="flex-col md:w-[35%] justify-center w-full">
            ...
            <div class="flex flex-col justify-center items-center mt-4 md:mt-6 lg:mt-0">
                <h1 class="lg:text-xl md:text-sm text-sm font-bold px-2 py-2 border-2 md:rounded-2xl rounded-lg border-hitam">Rima Ariona Nur Awalia, S.Pd</h1>
                <h1 class="lg:text-xl text-lg font-semibold text-center mt-2">Wali Kelas XI PPLG B</h1>
                <a href="/profil-rima" class="text-decoration-none w-[5rem] lg:w-[7rem] bg-secD border-2 border-hitam md:py-3 py-2 px-3 lg:px-6 mt-3 rounded-lg lg:text-xl text-sm font-bold text-hitam hover:text-orange hover:border-orange transition-all">Profile</a>
            </div>
        </div>
                    ...
                    <div class="block w-full items-center antialiased leading-relaxed h-auto">
                        <div class="swiper swiper-kelas lg:pt-[70px] mySwiper-kelas">
                            <div class="swiper-wrapper slide-kelas-wrap pb-20 ">
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (1).jpg') }}" />
                                </div>
                                
                                <div class="swiper-slide mx-2 img-fluid slide-kelas shadow-xl">
                                    <img class="rounded-2xl object-cover" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (8).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 img-fluid  slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (9).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 img-fluid slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (10).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 img-fluid  slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (11).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 img-fluid slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (12).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 img-fluid  slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (13).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 img-fluid  slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (14).jpg') }}" />
                                </div>
                            </div>
                        ...
                        <div class="swiper swiper-kelas lg:pt-[70px] mySwiper-kelas">
                            <div class="swiper-wrapper slide-kelas-wrap pb-20 ">
                                <div class="swiper-slide slide-kelas img-fluid mx-2 shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (39).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (40).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (41).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (42).jpg') }}" />
                                </div>
                                
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (2).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (2).jpg') }}" />
                                </div>
                ...
                <div class="hidden opacity-0" id="settings" role="tabpanel">
                    <div class="block w-full items-center antialiased leading-relaxed h-auto">
                        <div class="swiper swiper-kelas lg:pt-[70px] mySwiper-kelas">
                            <div class="swiper-wrapper slide-kelas-wrap pb-20 ">
                                <div class="swiper-slide mx-2 img-fluid  slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (4).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 img-fluid  slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (6).jpg') }}" />
                                </div>
                                <div class="swiper-slide  img-fluid mx-2 slide-kelas shadow-xl">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (7).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (3).jpg') }}" />
                                </div>
                                <div class="swiper-slide mx-2 slide-kelas">
                                    <img class="rounded-2xl" src="{{ Storage::url('assets/pplg/img/pplgb/pplgb (15).jpg') }}" />
                                </div>
                            </div>
                            <div class="flex justify-center">
                                <div class="arrow-swiper-kelas">
