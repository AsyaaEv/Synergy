<!-- Hero -->
<div class="w-full h-auto bg-white lg:pt-28 lg:pb-10 pt-16 pb-10 animate__animated animate__fadeIn">
            ...
            <div class="sm:w-full md:w-full lg:w-1/2 justify-between sm:relative md:relative lg:order-1">
                ...
                <div class="bg-white shadow-md p-2 hidden md:hidden absolute rounded-xl lg:flex gap-2 top-[1.5rem] -right-24">
                    ...
                    <div class="h-[5rem] hidden md:hidden lg:block w-auto">
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 fill-yellow-400 stroke-yellow-400">
                ...
                <div class="flex flex-col gap-2 md:flex-row lg:flex-col justify-between">
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <div class="space-x-3 flex">
                            <svg class="w-5 h-5 fill-slate-600 hover:fill-orange transition-all hover:-translate-y-2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
