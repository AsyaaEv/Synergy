        ...
        <div class="w-full px-2 mx-auto flex lg:flex-row flex-col">
            ...
            <div class="sm:w-full md:w-full lg:w-1/2 justify-between sm:relative md:relative lg:order-1">
                ...
                <div class="max-w-4xl flex sm:justify-center md:justify-end lg:justify-end">
                    <div
                        class="lg:w-[22rem] sm:w-full lg:h-[30rem] md:h-[27rem] sm:h-[350px] rounded-xl overflow-hidden">
                ...
                <div
                    class="absolute hidden md:hidden lg:block bottom-[1.5rem] lg:left-[5rem] w-[16rem] h-auto rounded-md shadow-md bg-white py-2 px-3">
                    ...
                    <div class="h-[5rem] hidden md:hidden lg:block w-auto">
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-4 h-4 fill-yellow-400 stroke-yellow-400">
            ...
            <!-- Bagian Kanan -->
            <div class="w-full md:w-full lg:w-[40%]">
                <div class="mb-10 hidden md:hidden lg:block">
                    <h1 class="font-extrabold lg:text-5xl md:text-3xl text-3xl text-slate-800 uppercase">Pengembangan
                        <span class="text-orange">Perangkat Lunak </span>dan Gim
                    </h1>
                </div>
                ...
                <div class="flex flex-col gap-2 md:flex-row lg:flex-col justify-between">
                        ...
                        <div class="w-auto h-6 flex gap-2 mb-12">
                            <a href=""
                                class="bg-orange py-4 text-decoration-none rounded-full px-8 text-white font-semibold flex gap-2 items-center justify-between hover:bg-transparent hover:text-orange transition-all duration-500"><span>Get
                                    Started</span><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <div class="space-x-3 flex">
                            <svg class="w-5 h-5 fill-slate-600 hover:fill-orange transition-all hover:-translate-y-2"
