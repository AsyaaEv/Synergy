<div class="w-full h-screen flex flex-col">
            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex flex-shrink-0 items-center">
                        <i class="ph-fill ph-list text-white text-2xl hover:cursor-pointer"></i>
                    </div>
                    <div class="hidden sm:ml-6 sm:invisible">
    ...
    <div class="w-[15rem] h-screen bg-[#0C0C1E]  absolute ">
        ...
        <div class="w-full h-auto mt-4 container">
            <div class="w-full h-auto border-b-[1px] shadow-md hover:border-[1px] rounded-[10px] py-2 flex items-center container gap-2 group hover:cursor-pointer bg-[#060714]">
