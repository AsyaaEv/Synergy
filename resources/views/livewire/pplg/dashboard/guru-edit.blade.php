                    ...
                    <form class="w-full h-auto gap-2 flex flex-col" wire:submit.prevent='edit'>
                        ...
                        <div class="flex items-center justify-center w-full flex-col">
                            ...
                            <label for="dropzone-file"
                                ...
                                <input id="dropzone-file" type="file" class="hidden" wire:model='fotoNew' />
                            </label>
                        </div>
                        @error('foto')
                        ...
                        <div class="w-full h-auto flex gap-4 ">
                            <div class="w-auto h-auto text-white">
                                <div class="">
                                    <div class="">{{!$fotoNew ? 'Before' : 'After'}}</div>
                                    <img src="{{ !$fotoNew ? Storage::url($this->foto) : $fotoNew->temporaryUrl() }}" alt="" class="w-[5rem] h-[5rem] object-cover">
                                </div>
                            </div>
                        </div>
                        <hr class="h-[1px] text-white my-2">
