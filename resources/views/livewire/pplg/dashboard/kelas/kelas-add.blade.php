                ...
                <div class="w-full bg-primaryD h-auto rounded-[10px] container pb-4">
                    <div class="w-full h-auto flex gap-2 pt-2 ">
                        ...
                        <div class="w-auto h-auto">
                            <div class="font-bold text-xl text-white">Tambah Kelas</div>
                            <div class="font-normal text-md text-white opacity-50">Isi data dibawah ini untuk menambahkan kelas
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="w-full h-auto gap-2 flex flex-col" wire:submit.prevent='saveKelas'>
                        ...
                        <div class="w-full h-auto flex flex-col">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="input-group-1"
                                    class="bg-gray-50 @error('angkatan') border-[2px] border-red-500 placeholder:text-red-500 @enderror font-semibold text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Angkatan" wire:model='angkatan'>
                            </div>
                        </div>
                        <div class="w-full h-auto flex flex-col">
