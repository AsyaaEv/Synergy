                ...
                <div class="w-full bg-primaryD h-auto rounded-[10px] container pb-4">
                    <div class="w-full h-auto flex gap-2 pt-2 ">
                        ...
                        <div class="w-auto h-auto">
                            <div class="font-bold text-xl text-white">Tambah WaliKelas</div>
                            <div class="font-normal text-md text-white opacity-50">Isi data dibawah ini untuk menambahkan Walikelas
                            </div>
                        </div>
                    </div>
