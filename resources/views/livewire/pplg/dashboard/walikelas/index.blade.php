            ...
            <div class="w-full h-full rounded-[10px] sm:pl-[15rem] flex flex-col gap-2 overflow-auto pb-[5rem]">
                <div class="w-full h-auto flex">
                    <div class="w-full h-auto">
                        ...
                        <div class="text-white/50">Wali Kelas PPLG</div>
                    </div>
                    <div class="px-2  py-3 rounded-[10px] flex justify-between items-center absolute transition-all z-50 @if (!empty(session('alert'))) alert-{{ session('alert') }} @else d-none @endif" id="alert">
                        <div id="alert-border-1" class="flex items-center rounded-[10px] p-4 mb-4 @if (!empty(session('alert'))) text-{{ session('alert') }} border-t-4 border-{{ session('alert') }} bg-blue-50 @endif" role="alert">
                            ...
                            <button type="button" onclick="" class="ms-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-border-1" aria-label="Close">
                ...
                <div id="alert-border-1"
                    ...
                    <a href="/dashboard/walikelas/add"
                    ...
                    <div class="w-full h-[6rem] bg-primaryD rounded-[10px] flex gap-2 shadow-md">
                        ...
                        <div class="w-full h-full flex justify-center items-center flex-col">
                            <div class="w-full h-full flex items-center gap-2">
                                ...
                                <div class="text-white">Nama : <strong>{{$item->nama_panggilan}}</strong></div>
                            </div>
                            <div class="w-full h-full flex items-center gap-2">
                                <i class="ph-fill ph-book text-white text-2xl"></i>
                                <div class="text-white">Guru : <strong>{{$item->guru}}</strong></div>
                            </div>
                            <div class="w-full h-full flex items-center gap-2">
                                <i class="ph-fill ph-door text-white text-2xl"></i>
                                <div class="text-white">Walikelas : <strong>{{$item->walikelas}}</strong></div>
                            </div>
                        </div>
                        <div class="w-[20%] h-auto flex flex-col justify-between items-center py-2 mr-2">
                            <a href="{{url('/dashboard/walikelas/edit/' .$item->id)}}"
